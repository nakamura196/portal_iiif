...
collection = "kahei"
base_url = "https://da.dl.itc.u-tokyo.ac.jp/portal/search?collection=151&sort_by=field_title&_format=json"
...
def get_img_arr(soup):
    img_arr = []
    divs = soup.find_all(class_="xword_wrap_break")
    for div in divs:
        a_s = div.find_all("a")
        for a in a_s:
            img_url = a.get("href")
